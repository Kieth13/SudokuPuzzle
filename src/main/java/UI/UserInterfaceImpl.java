...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(250, 235, 239);
    ...
    private void styleTile(SudokuTextField tile, double x, double y) {
    ...
    private void handleInput(int value, Object source) {
        listener.onSudokuInput(((SudokuTextField) source).getX(),
                ((SudokuTextField) source).getY(),value);
    }
}
